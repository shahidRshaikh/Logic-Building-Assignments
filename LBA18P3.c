/*
   Accept N number from user and display all such elemnts which is even and Divisible by 5.
...
//  Description     : check element is even and divisible by 5.
...
void Display(int Arr[], int iSize)
{
    ...
    {
        if (((Arr[iCnt] %2) == 0) && ((Arr[iCnt] % 5) == 0)) // Check number is even and divisible by 5
        {
            printf("\n");
