/*
   Accept N number from user and display all such elemnts which is and Divisible by 3 and 5.
...
//  Description     : check element is divisible by 3 and 5.
//  Input Arguments : Integer array (Arr) - contains N elements
//                    Integer (iSize) - number of elements in the array
//  Output          : Display the elements is divisible by 3 and 5.
//  Author          : Omkar Santosh Wagh
//  Date            : 03/06/2025
//
//////////////////////////////////////////////////////////////////////////////////////////////
void Display(int Arr[], int iSize)
{
    ...
    {
        if (((Arr[iCnt] %  3) == 0) && ((Arr[iCnt] % 5) == 0)) // Check number is divisible by 3 and 5
        {
            printf("\n");
